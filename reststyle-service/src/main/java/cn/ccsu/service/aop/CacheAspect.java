...
import cn.ccsu.commom.annotation.CacheData;
...
public class CacheAspect
{
     ...
     * @see CacheData
     */
    @Pointcut("@annotation(cn.ccsu.commom.annotation.CacheData)")
    ...
    private String getCacheKey(CacheData cacheData, String className, String methodName, ProceedingJoinPoint pjpParam)
    {
        ...
        String paramJson = JacksonUtil.object2Json(paramMap);
        log.debug("[ CacheAspect ] >> param-JSON:{}", JacksonUtil.object2Json(paramMap));
